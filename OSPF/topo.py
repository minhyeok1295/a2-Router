...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(s2, r2, intfName2='r2-eth0', params2={'ip': '10.1.0.1/24'})
        
        self.addLink(s3, m, intfName2='r3-eth0', params2={'ip': '10.2.0.1/24'})
        ...
        h1 = self.addHost(name='h1',ip='10.0.0.10/24',defaultRoute='via 10.0.0.1')
