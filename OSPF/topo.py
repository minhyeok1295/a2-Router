...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(m, r2, intfName1='m-eth1', intfName2='r2-eth1', params1={'ip': '10.10.0.3/24'}, params2={'ip': '10.10.0.4/24'})       
        self.addLink(m, r3, intfName1='m-eth1', intfName2='r3-eth1', params1={'p': '10.10.0.5/24'}, params2={'ip': '10.10.0.6/24'})        
