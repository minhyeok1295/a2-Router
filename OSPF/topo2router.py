...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(r1, m1, intfName1='r1-eth1', intfName2='m1-eth1', params1={'ip': '10.11.0.1/24'}, params2={'ip': '10.11.0.2/24'})
        self.addLink(r2, m1, intfName1='r2-eth1', intfName2='m1-eth2', params1={'ip': '10.12.0.1/24'}, params2={'ip': '10.12.0.2/24'})
