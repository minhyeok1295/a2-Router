...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(sm, m1, intfName2='m1-eth0', params2={'ip': '10.0.0.1/24'})
        ...
        self.addLink(m1, r1, intfName1='m-eth1', intfName2='r1-eth1', params1={'ip': '10.11.0.1/24'}, params2={'ip': '10.11.0.2/24'}) 
        self.addLink(m1, r2, intfName1='m-eth2', intfName2='r2-eth1', params1={'ip': '10.12.0.1/24'}, params2={'ip': '10.12.0.2/24'})       
        self.addLink(m1, r3, intfName1='m-eth3', intfName2='r3-eth1', params1={'ip': '10.13.0.1/24'}, params2={'ip': '10.13.0.2/24'})        
...
def run():
    ...
    info(net['m1'].cmd("ip route add 10.1.0.0/24 via 10.11.0.2 dev m-eth1"))
    info(net['m1'].cmd("ip route add 10.2.0.0/24 via 10.12.0.2 dev m-eth2"))
    info(net['m1'].cmd("ip route add 10.3.0.0/24 via 10.13.0.2 dev m-eth3"))

    
    info(net['r1'].cmd("ip route add 10.0.0.0/24 via 10.11.0.1 dev r1-eth1"))
    ...
    info(net['r2'].cmd("ip route add 10.0.0.0/24 via 10.12.0.1 dev r2-eth1"))
    ...
    info(net['r3'].cmd("ip route add 10.0.0.0/24 via 10.13.0.1 dev r3-eth1"))
