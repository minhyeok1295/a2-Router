...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(r1, r3, intfName1='r1-eth2', intfName2='r3-eth1', params1={'ip': '10.10.0.3/24'}, params2={'ip': '10.10.0.4/24'})
        self.addLink(r2, r3, intfName1='r2-eth2', intfName2='r3-eth2', params1={'ip': '10.10.0.5/24'}, params2={'ip': '10.10.0.6/24'})
        
        
        self.addLink(r1, m, intfName1='r1-eth50', intfName2='m-eth1', params1={'ip': '10.101.0.1/24'}, params2={'ip': '10.101.0.2/24'})
        self.addLink(r2, m, intfName1='r2-eth50', intfName2='m-eth2', params1={'ip': '10.102.0.1/24'}, params2={'ip': '10.102.0.2/24'})
        self.addLink(r3, m, intfName1='r3-eth50', intfName2='m-eth3', params1={'ip': '10.103.0.1/24'}, params2={'ip': '10.103.0.2/24'})
...
def run():
    ...
    info(net['r1'].cmd("ip route add 10.3.0.0/24 via 10.10.0.4 dev r1-eth2"))
    info(net['r1'].cmd("ip route add 10.0.0.0/24 via 10.101.0.2 dev r1-eth50"))
    
    info(net['r2'].cmd("ip route add 10.1.0.0/24 via 10.10.0.1 dev r2-eth1"))
    info(net['r2'].cmd("ip route add 10.3.0.0/24 via 10.10.0.6 dev r2-eth2"))
    info(net['r2'].cmd("ip route add 10.0.0.0/24 via 10.102.0.2 dev r2-eth50"))
    
    info(net['r3'].cmd("ip route add 10.1.0.0/24 via 10.10.0.3 dev r2-eth1"))
    info(net['r3'].cmd("ip route add 10.2.0.0/24 via 10.10.0.5 dev r2-eth2"))
    info(net['r3'].cmd("ip route add 10.0.0.0/24 via 10.103.0.2 dev r3-eth50"))
